    ...
    public static class NewRider
    {
            ...
            using (OutPacket oPacket = new OutPacket("LoRpGetRiderItemPacket"))
            {
                ...
                for (short i = 1; i <= NewRider.MaxKart; i++)
                {
                    if (i <= 25 || i == 27 || i == 29 || i == 45 || i == 54 || i == 59 ||
                        ...
                        i == 832 || i == 833 || i == 835 || i == 837 || i == 838 || i == 839 || i == 840 || i == 841 || i == 843 || i == 845 || i == 847 || i == 850 || i == 851 || i == 852 || i == 1193 ||
                        i == 1195 || i == 1199 || i == 1206 || i == 1208 || i == 1212 || i == 1215 || i == 1221 || i == 1222 || i == 1225 || i == 1226 || i == 1229 || i == 1230 || i == 1234 || i == 1238 || i == 1239 ||
                        i == 1247 || i == 1251 || i == 1252 || i == 1261 || i == 1264 || i == 1265 || i == 1268 || i == 1271 || i == 1275 || i == 1285 || i == 1288 || i == 1289 || i == 1297 || i == 1302)
                    {
        ...
        public static void HeadBand()
        {
            using (OutPacket oPacket = new OutPacket("LoRpGetRiderItemPacket"))
            {
                ...
                oPacket.WriteInt(1);
                int HeadBand = 484;
                oPacket.WriteInt(HeadBand + 5 - 41);
                ...
                for (short i = 1; i <= HeadBand; i++)
                {
                    if (i == 16 || i == 21 || i == 23 || i == 29 || i == 37 || i == 39 || i == 40 || i == 41 || i == 43 || i == 44 ||
                        ...
                        i == 291 || i == 327 || i == 353 || i == 385 || i == 386 || i == 387 || i == 412 || i == 414 || i == 466 || i == 467 || 
                        i == 468)
                    {
                    }
                    else
        ...
        public static void HandGearL()
        {
            using (OutPacket oPacket = new OutPacket("LoRpGetRiderItemPacket"))
            {
                ...
                oPacket.WriteInt(1);
                int HandGearL = 303;
                oPacket.WriteInt(HandGearL + 6 - 70);
