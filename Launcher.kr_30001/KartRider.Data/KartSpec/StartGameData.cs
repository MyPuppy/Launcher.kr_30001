    ...
    public class StartGameData
    {
        ...
        public static void PrStartTimeAttack()
        {
            using (OutPacket oPacket = new OutPacket("PrStartTimeAttack"))
            {
                ...
                oPacket.WriteEncFloat(SpeedType.ForwardAccelForce + Kart.ForwardAccelForce + FlyingPet.ForwardAccelForce + TuneSpec.Plant_ForwardAccelForce + SpeedPatch.ForwardAccelForce);
                ...
                oPacket.WriteEncFloat(SpeedType.DriftEscapeForce + Kart.DriftEscapeForce + FlyingPet.DriftEscapeForce + TuneSpec.Tune_DriftEscapeForce + TuneSpec.Plant_DriftEscapeForce + SpeedPatch.DriftEscapeForce);
                oPacket.WriteEncFloat(SpeedType.CornerDrawFactor + Kart.CornerDrawFactor + FlyingPet.CornerDrawFactor + TuneSpec.Plant_CornerDrawFactor + SpeedPatch.CornerDrawFactor);
                ...
                oPacket.WriteEncFloat(SpeedType.TransAccelFactor + Kart.TransAccelFactor + TuneSpec.Tune_TransAccelFactor + TuneSpec.Plant_TransAccelFactor + SpeedPatch.TransAccelFactor);
                ...
                oPacket.WriteEncFloat(Kart.StartBoosterTimeSpeed + TuneSpec.Tune_StartBoosterTimeSpeed + TuneSpec.Plant_StartBoosterTimeSpeed);
        ...
        public static void KartSpecLog()
        {
            ...
            Console.WriteLine("ForwardAccelForce: {0}", SpeedType.ForwardAccelForce + Kart.ForwardAccelForce + FlyingPet.ForwardAccelForce + TuneSpec.Plant_ForwardAccelForce + SpeedPatch.ForwardAccelForce);
            ...
            Console.WriteLine();
            Console.Write("DriftEscapeForce: {0}", SpeedType.DriftEscapeForce + Kart.DriftEscapeForce + FlyingPet.DriftEscapeForce + TuneSpec.Tune_DriftEscapeForce + TuneSpec.Plant_DriftEscapeForce + SpeedPatch.DriftEscapeForce);
            Console.Write(" (T:{0} P:{1})", TuneSpec.Tune_DriftEscapeForce, TuneSpec.Plant_DriftEscapeForce);
            Console.WriteLine();
            Console.WriteLine("CornerDrawFactor: {0}", SpeedType.CornerDrawFactor + Kart.CornerDrawFactor + FlyingPet.CornerDrawFactor + TuneSpec.Plant_CornerDrawFactor + SpeedPatch.CornerDrawFactor);
            Console.WriteLine();
            if (StartGameData.StartTimeAttack_SpeedType == 4 || StartGameData.StartTimeAttack_SpeedType == 6)
            {
            ...
            Console.WriteLine();
            Console.WriteLine();
            Console.Write("TransAccelFactor: {0}", SpeedType.TransAccelFactor + Kart.TransAccelFactor + TuneSpec.Tune_TransAccelFactor + TuneSpec.Plant_TransAccelFactor + SpeedPatch.TransAccelFactor);
            Console.Write(" (T:{0} P:{1})", TuneSpec.Tune_TransAccelFactor, TuneSpec.Plant_TransAccelFactor);
            Console.WriteLine();
